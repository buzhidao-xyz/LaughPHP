...
;(function()
{
	...
	function Brush()
	{
		var keywords =	'break case catch continue document event ' +
...
;(function()
{
	...
	function Brush()
	{
		var funcs	=	'abs acos acosh addcslashes addslashes ' +
						...
						'floatval flock floor flush fmod fnmatch fopen fwrite fpassthru fprintf fputcsv fputs fread fscanf '+
						...
						'strtoupper strtr strval substr substr_compare header phpinfo __construct set_time_limit ' +
                        'date_default_timezone_set preg_match list implode pack unpack print_r ';
